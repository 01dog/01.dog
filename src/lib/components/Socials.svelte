...
<script>
	...
	let discordTag = '1dog';
	// is this correct? idk feels DRY
	let dataTip = {
		default: 'click to copy my username',
		copied: 'copied "1dog" to clipboard!'
	};
	let tip = $state(dataTip.default);
...
<!-- TODO: this entire section needs to be redone in a smarter way-->
<grid class="grid grid-cols-4 gap-4 max-w-2xl place-items-center">
	...
	<div class="tooltip" data-tip={tip} value="1dog">
		<CopyToClipboard text={discordTag} on:copy={handleCopied} on:fail={handleFailedCopy} >
			{#snippet children({ copy })}
						<button onclick={copy} class="btn btn-neutral gap-2">
					<svg role="img" class="h-6 w-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
	...
	<div>
		<!-- <LinkedButton href="https://github.com/01dog">
			<svg role="img" class="h-6 w-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
		...
		<LinkedButton href="https://glass.photo/1dog">
			<svg role="img" class="h-6 w-6" viewBox="0 0 640 640" xmlns="http://www.w3.org/2000/svg" 
				><title>Glass</title><path 
	...
	<div>
		<LinkedButton href="https://steamcommunity.com/profiles/76561198035136145">
			<svg role="img" class="h-6 w-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
	...
	<div>
		<LinkedButton href="https://twitter.com/xchgraxrax">
			<svg role="img" class="h-6 w-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
	...
	<div class="col-span-4 text-2xl font-bold text-center mt-4 mb-2">
