...
<script>
	// import Copy from '$lib/componenets/Copy.svelte';
	import CopyToClipboard from 'svelte-copy-to-clipboard';

	let discordTag = '1dog#0001';
	let dataTip = 'click to copy my username';
...
<grid class="grid grid-cols-4 gap-4 max-w-2xl place-items-center">
	...
	<div>
		<a role="button" href="https://github.com/01dog" target="noopener" class="btn gap-2">
			<svg role="img" class="h-6 w-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
	...
	<div>
		<a
			role="button"
			href="https://steamcommunity.com/profiles/76561198035136145"
			target="noopener"
			class="btn gap-2"
		>
			<svg role="img" class="h-6 w-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
	...
	<div>
		<a role="button" href="https://twitter.com/xchgraxrax" target="noopener" class="btn gap-2">
			<svg role="img" class="h-6 w-6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
